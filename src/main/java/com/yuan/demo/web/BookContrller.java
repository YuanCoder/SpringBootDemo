...
import com.yuan.demo.entity.Book;
...
public class BookContrller {
    //注意 ： swagger没有做安全方面的防护，可能需要我们自己做相关的工作。
    ...
    @ApiImplicitParam(name = "id", value = "图书ID", required = true, dataType = "Long",paramType = "path")   // 请求参数在url上，@ApiImplicitParam 上加paramType = “path”
